<template>
  <div style="margin-left:20px;">
    ...
    <el-table-column width="200px" align="center" label="资源编码" :show-overflow-tooltip="true"><template slot-scope="scope">
  <span>
    {{scope.row.code}}</span>
</template>
  ...
  <span>
    ...
    <el-table-column width="200px" align="center" label="资源名称" :show-overflow-tooltip="true"><template slot-scope="scope">
  <span>
    {{scope.row.name}}</span>
</template>

</el-table-column>
    <el-table-column width="200px" align="center" label="资源地址" :show-overflow-tooltip="true"><template slot-scope="scope">
  <span>
    {{scope.row.uri}}</span>
</template>
</el-table-column>
  ...
  <span>
    ...
    <el-table-column width="200px" align="center" label="描述" :show-overflow-tooltip="true"><template slot-scope="scope">
  <span>
